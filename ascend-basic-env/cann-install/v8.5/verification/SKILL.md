---
name: verification
description: Verify CANN 8.5.0 installation and environment on Ascend NPU. Use when checking if CANN, drivers, and NPU devices are correctly installed and configured.
---

# Installation Verification

Verify CANN 8.5.0 installation is working correctly.
...
| CANN version | `cat .../version.info` | Version=8.5.0 |
| Env vars set | `echo $ASCEND_TOOLKIT_HOME` | Path displayed |
| NPU available | `torch.npu.is_available()` | True |

## Official Reference

- [Verification Guide](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/850/softwareinst/instg/instg_0000.html)
